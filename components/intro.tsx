    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/collins_nwoko.jpg"
              alt="Collins Nwoko portrait"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        <span className="font-bold">Hello, I'm Collins.</span> I'm a{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/chibuke-nwoko-b09294100"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/colin-nwk"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
